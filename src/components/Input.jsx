...
const InputTask = ({ setToken, user }) => {
    ...
    return (
        ...
        <>
            ...
            <div className="relative flex items-center pt-11 mx-auto px-5 max-w-286 w-full">
                ...
                <input type="text"
                    ...
                    font-[Baloo] outline-none border bg-[#C4BABA5E] border-[#FFFFFFB2] ml-40 pl-4 
                ...
                <button onClick={addTask}
                    className=" rounded-full border bg-[#C4BABA5E] border-[#FFFFFFB2] ml-5 
                    flex items-center justify-center shadow-lg backdrop-blur-md" >
        ...
        w-62 h-15 font-normal text-[24px] leading-[100%] rounded-xl border bg-[#C4BABA5E] border-[#FFFFFFB2] pl-6.25 cursor-pointer">
                ...
                <div className="ml-15 relative" ref={dropdownRef}>
        ...
        bg-white/10 backdrop-blur-xl border border-white/20 z-50 overflow-hidden">
                            ...
                            <div className="px-3 py-4 border-b border-white/20">
                                <div className="flex items-center gap-1">
                                    <div className="w-20 h-9 rounded-full bg-linear-to-r from-[#C4564D] to-[#864B49]
    ...
    overflow-y-auto overflow-x-hidden">
                ...
                {filteredTasks.map((task) => (
                    ...
                    <li key={task._id}
                        className="max-w-155 rounded-[85px] py-2 bg-[#C4BABA5E] border border-[#FFFFFFB2] mb-4 w-full
                        shadow-lg backdrop-blur-md">
